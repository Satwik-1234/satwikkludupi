              ...
              {techStack.map((tech, index) => (
                ...
                >
                  <div className="group relative">
                    {/* 3D Card Effect */}
                    <div 
                      className="w-24 h-24 md:w-28 md:h-28 rounded-2xl border border-border/30 bg-card/50 backdrop-blur-sm p-4 flex items-center justify-center transition-all duration-300 group-hover:border-primary/40 group-hover:shadow-[0_20px_40px_-15px_hsl(var(--primary)/0.3)]"
                      style={{
